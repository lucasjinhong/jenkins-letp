...
def avms_package_setup_teardown(
    ...
    print("\nA_HL_INT_AVMS_RADIO_0000 TC Start:\n")
    ...
    test_nb = ""
    test_ID = "A_HL_INT_AVMS_RADIO_0000"
...
def A_HL_INT_AVMS_RADIO_0000(read_config, avms_client, otii_setup_teardown, avms_package_setup_teardown, target_at):
    """
    ...
    # Configure turning radio off and on by +cfun=0/1 command during firmware download
    action = 2
